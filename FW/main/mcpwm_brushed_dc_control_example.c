...
{
    motor_ctrl.cfg.pid_enable = false;
...
static void motor_ctrl_mcpwm_init(void)
{
    ...
    pwm_config.frequency = 120000;               // frequência = 500Hz,
    ...
    // pwm_config.duty_mode = MCPWM_DUTY_MODE_0;
    mcpwm_init(MCPWM_UNIT_0, MOTOR_CTRL_MCPWM_TIMER, &pwm_config);
    mcpwm_deadtime_enable(MCPWM_UNIT_0, MCPWM_TIMER_0, MCPWM_ACTIVE_HIGH_COMPLIMENT_MODE, R_EDGE_DT, F_EDGE_DT);
